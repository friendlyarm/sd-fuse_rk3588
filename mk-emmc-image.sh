...
function usage() {
       echo "Usage: $0 <buildroot|friendlywrt23|friendlywrt23-docker|friendlywrt22|friendlywrt22-docker|friendlywrt21|friendlywrt21-docker|friendlycore-focal-arm64|openmediavault-arm64|debian-buster-desktop-arm64> [img filename] [options]"
       echo "    examples:"
