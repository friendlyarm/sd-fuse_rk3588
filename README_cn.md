...
* 分区镜像文件: 在[网盘](https://download.friendlyelec.com/rk3588)的 "03_分区镜像文件/old/kernel-5.10.y" 目录中, 或者从[此http链接](https://cdn.friendlyelec.com/os-images/rk3588/images)下载
...
下载本仓库到本地, 然后下载并解压ubuntu-jammy-desktop系统的[分区镜像文件压缩包](https://cdn.friendlyelec.com/os-images/rk3588/images), 由于http服务器带宽的关系, wget命令可能会比较慢, 推荐从网盘上下载同名的文件:
```
...
*注: 这里以ubuntu-jammy-desktop系统为例进行说明*  
下载本仓库到本地, 然后下载并解压[分区镜像文件压缩包](https://cdn.friendlyelec.com/os-images/rk3588/images), 这里需要下载ubuntu-jammy-desktop和eflasher系统的文件:
```
git clone https://github.com/friendlyarm/sd-fuse_rk3588 -b master --single-branch sd-fuse_rk3588-master
cd sd-fuse_rk3588-master
wget https://cdn.friendlyelec.com/os-images/rk3588/images/ubuntu-jammy-desktop-arm64-images.tgz
...
#### 从根文件系统制作一个可启动的SD卡
*注: 这里以ubuntu-jammy-desktop系统为例进行说明*  
下载本仓库到本地, 然后下载并解压[分区镜像压缩包](https://cdn.friendlyelec.com/os-images/rk3588/images):
```
git clone https://github.com/friendlyarm/sd-fuse_rk3588 -b master --single-branch sd-fuse_rk3588-master
cd sd-fuse_rk3588-master
wget https://cdn.friendlyelec.com/os-images/rk3588/images/ubuntu-jammy-desktop-arm64-images.tgz
